...
declare const EDITOR_WINDOW_PRELOAD_WEBPACK_ENTRY: string; // TODO What does this do?
...
class EditorWindow extends Window {
  ...
  constructor(interpreter: string) {
    ...
    this.window.once("ready-to-show", () => this.initPty(interpreter));
